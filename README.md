...
|CDC Processed Secure Dataset  |`_DS_CDC_SEC`      |`SAP.datasets.cdcSEC`    | Dataset that works as security layer over the cdc processed one. |
|CDC Processed Secure Dataset  |`_DS_CDC_RT`      |`SAP.datasets.cdcRT`    | Source dataset, realtime version |
